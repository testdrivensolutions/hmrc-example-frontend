...
import forms.DateOfBirthYesNoFormProvider
...
class DateOfBirthYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  "DateOfBirthYesNo Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(DateOfBirthYesNoPage, true).success.value
